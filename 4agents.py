...
def run_simulation():
    # THE STRESS TEST: 4-Way Intersection
    obstacles = [
        (-2.0, -2.0, 6.0, 6.0),  # Bottom-Left Block
        (-2.0, 6.0, 6.0, 6.0),   # Top-Left Block
        (6.0, -2.0, 6.0, 6.0),   # Bottom-Right Block
        (6.0, 6.0, 6.0, 6.0),    # Top-Right Block
    ]
    
    # 4 Agents crossing through the center
    agents = [
    ...
    ani.save('output/4agents_simulation.mp4', writer='ffmpeg', fps=20)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('output/distance_error_plot_4agents.png', dpi=300)
    # ---------------------------------------------------------
